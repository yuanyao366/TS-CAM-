...
__C.MODEL.CAM_MERGE = 'SUM'
__C.MODEL.ATTN_DISCARD_RATIO = 0.0
...
__C.SOLVER.LOSS = 'CE'
__C.SOLVER.LOSS_SCALE = 1.0
__C.SOLVER.LOSS2 = 'CE'
__C.SOLVER.LOSS2_SCALE = 1.0
...
__C.TEST.CLS_LOGITS = 'PTCT'
__C.TEST.CAM_TYPE = 'MeanAttenCam'
__C.TEST.IOU_THR = 0.5
...
def update_config():
    ...
    parser.add_argument('--extra_token_blk_idx', default=-1, type=int, help='extra token block index')
    ...
    parser.add_argument('--resume_cls', default='', help='resume_cls from checkpoint')
