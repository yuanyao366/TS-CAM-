...
__all__ = [
    'deit_cls_attn_cam_tiny_patch16_224', 'deit_cls_attn_cam_small_patch16_224', 'deit_cls_attn_cam_base_patch16_224',
]
...
class TSAttnCAM(VisionTransformer):
...
@register_model
def deit_cls_attn_cam_tiny_patch16_224(pretrained=False, **kwargs):
    model = TSAttnCAM(
...
@register_model
def deit_cls_attn_cam_small_patch16_224(pretrained=False, **kwargs):
    model = TSAttnCAM(
...
@register_model
def deit_cls_attn_cam_base_patch16_224(pretrained=False, **kwargs):
    model = TSAttnCAM(
